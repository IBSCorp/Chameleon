...
import ru.ibsqa.chameleon.element.ElementTypeConnection;
import ru.ibsqa.chameleon.element.ElementTypeQuery;
...
public class DbStorySteps extends AbstractSteps {
    ...
    @Context(type = ElementTypeConnection.class, change = ContextChange.AFTER, parameter = "connectionName")
    ...
    @Context(type = ElementTypeConnection.class, change = ContextChange.BEFORE, parameter = "connectionName")
    ...
    @Context(type = ElementTypeQuery.class, change = ContextChange.AFTER, parameter = "queryName")
    ...
    @Context(type = ElementTypeQuery.class, change = ContextChange.BEFORE, parameter = "queryName")
