...
public class CollectionStorySteps extends AbstractSteps implements ICollectionUtils {
    ...
    @Context(type = ElementTypeCollection.class, change = ContextChange.BEFORE, parameter = "collectionName")
    ...
    @Context(
            type = ElementTypeCollection.class,
    ...
    public void stepWaitCollectionElements(@Collection String collectionName,
                                           @Value String seconds
    ) {
        this.flow(() ->
