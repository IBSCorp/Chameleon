...
import ru.ibsqa.chameleon.api.context.IContextManagerApiResponse;
...
import ru.ibsqa.chameleon.element.ElementTypeEndpoint;
import ru.ibsqa.chameleon.element.ElementTypeRequest;
import ru.ibsqa.chameleon.element.ElementTypeResponse;
import ru.ibsqa.chameleon.json.utils.DataUtils;
import ru.ibsqa.chameleon.steps.roles.Value;
import ru.ibsqa.chameleon.steps.roles.Write;
...
public class ApiStorySteps extends AbstractSteps {
    ...
    @Context(type = ElementTypeEndpoint.class, change = ContextChange.AFTER, parameter = "endpointName")
    ...
    @Context(type = ElementTypeRequest.class, change = ContextChange.AFTER, parameter = "requestName", delete = ElementTypeResponse.class)
    ...
    @Context(type = ElementTypeRequest.class, change = ContextChange.BEFORE, parameter = "requestName", delete = ElementTypeResponse.class)
    ...
    @Context(type = ElementTypeRequest.class, change = ContextChange.BEFORE)
    ...
    @Context(type = ElementTypeResponse.class, change = ContextChange.AFTER, value = "currentResponse")
    ...
    @Context(type = ElementTypeResponse.class, change = ContextChange.BEFORE)
    ...
    @Context(type = ElementTypeResponse.class, change = ContextChange.AFTER, parameter = "responseName")
    ...
    @Context(type = ElementTypeResponse.class, change = ContextChange.BEFORE, parameter = "responseName")
    ...
    public void validateResponseStatusCodes(String expectedStatusCodes) {
        flow(() -> {
            int[] expectedStatusCodesInt = Arrays.stream(expectedStatusCodes.split("\\s*,\\s*"))
