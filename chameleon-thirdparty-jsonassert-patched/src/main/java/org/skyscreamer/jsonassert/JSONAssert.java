...
public class JSONAssert {
    ...
    public static void assertEquals(String message, String expectedStr, JSONObject actual, JSONCompareMode compareMode)
        ...
        if (expected instanceof JSONObject) {
            ...
            throw new AssertionError(localeManager.getMessage("jsonassert.expecting.json.array.but.passing.in.json.object"));
            /* LOCALIZE:
    ...
    public static void assertEquals(String message, String expectedStr, JSONArray actual, JSONCompareMode compareMode)
        ...
        if (expected instanceof JSONArray) {
            ...
            throw new AssertionError(localeManager.getMessage("expecting.json.object.but.passing.in.json.array"));
            /* LOCALIZE:
    ...
    public static void assertEquals(String message, String expectedStr, String actualStr, JSONCompareMode compareMode)
        ...
        if (expectedStr==null){
            throw new AssertionError(localeManager.getMessage("jsonassert.expected.string.is.null"));
            /* LOCALIZE:
            throw new AssertionError("Expected string is null.");
            */
        }else if (actualStr==null){
            throw new AssertionError(localeManager.getMessage("jsonassert.actual.string.is.null"));
            /* LOCALIZE:
