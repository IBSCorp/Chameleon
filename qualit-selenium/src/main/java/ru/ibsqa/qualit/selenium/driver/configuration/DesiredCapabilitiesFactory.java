...
import ru.ibsqa.qualit.selenium.driver.configuration.options.DefaultChromeOptions;
import ru.ibsqa.qualit.selenium.driver.configuration.options.DefaultFirefoxOptions;
