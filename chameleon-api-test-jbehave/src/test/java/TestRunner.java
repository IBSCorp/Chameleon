...
//import ru.ibsqa.chameleon.definitions.repository.api.Endpoint;
...
//import ru.ibsqa.chameleon.utils.commandpromt.CommandPromptImpl;
...
//
//        // Create temp folder
//        directory = new File(System.getProperty("java.io.tmpdir"), "Chemeleon.Test");
//        if (!directory.exists()) {
//            directory.mkdirs();
//        }
//        try {
