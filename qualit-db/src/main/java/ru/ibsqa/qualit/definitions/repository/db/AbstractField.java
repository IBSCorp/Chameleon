...
public abstract class AbstractField implements IRepositoryElement {
    ...
    @Getter
    private AbstractFieldList fieldList;

    void afterUnmarshal(Unmarshaller unmarshaller, Object parent) {
        this.fieldList = (AbstractFieldList)parent;
    }

    public FieldChapter getChapter() {
        return FieldChapter.getChapter(this.getFieldList().getClass());
    }
