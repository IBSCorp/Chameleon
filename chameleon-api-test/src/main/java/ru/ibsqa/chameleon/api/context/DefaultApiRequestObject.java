...
import ru.ibsqa.chameleon.api.authentication.IApiAuthentication;
import ru.ibsqa.chameleon.api.cookie.IApiCookie;
import ru.ibsqa.chameleon.api.reporter.IApiLogger;
import ru.ibsqa.chameleon.api.reporter.ReportInformerApiTimingImpl;
import ru.ibsqa.chameleon.api.reporter.RequestLogReceiver;
import ru.ibsqa.chameleon.api.reporter.ResponseLogReceiver;
import ru.ibsqa.chameleon.definitions.repository.IRepositoryElement;
import ru.ibsqa.chameleon.definitions.repository.api.ContentTypeEnum;
...
import ru.ibsqa.chameleon.elements.IFacadeWritable;
