...
public class JSONCompareResult {
    ...
    /**
     * Dot-separated path the field that failed comparison
     * 
     ...
     * Identify that the comparison failed
     * @param field Which field failed
     * @param exception exceptions containing details of match failure
     * @return result of comparision
     */
    ...
    private String formatFailureMessage(String field, Object expected, Object actual) {
        return field + localeManager.getMessage("jsonassert.expected.got", describe(expected), describe(actual));
        /* LOCALIZE:
        return field
                + "\nExpected: "
                + describe(expected)
    ...
    private String formatMissing(String field, Object expected) {
        return field + localeManager.getMessage("jsonassert.expected.but.none.found", describe(expected));
        /* LOCALIZE:
        return field
                + "\nExpected: "
                + describe(expected)
    ...
    private String formatUnexpected(String field, Object actual) {
        return field + localeManager.getMessage("jsonassert.unexpected", describe(actual));
        /* LOCALIZE:
        return field
                + "\nUnexpected: "
                + describe(actual)
    ...
    private static String describe(Object value) {
        if (value instanceof JSONArray) {
            return localeManager.getMessage("jsonassert.array");
        } else if (value instanceof JSONObject) {
            return localeManager.getMessage("jsonassert.object");
        } else {
