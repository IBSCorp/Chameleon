...
Write JSON unit ru.ibsqa.qualit.tests in less code.  Great for testing REST interfaces.

Summary
-------

Write JSON ru.ibsqa.qualit.tests as if you are comparing a string.  Under the covers, JSONassert converts your string into a JSON object and compares the logical structure and data with the actual JSON.  When _strict_ is set to false (recommended), it forgives reordering data and extending results (as long as all the expected elements are there), making ru.ibsqa.qualit.tests less brittle.
...
Write ru.ibsqa.qualit.tests like this:
