...
public class DecorateManagerImpl implements IDecorateManager {
    ...
    public <T extends WebElementFacade> T decorateElement(IElementLocatorFactory elementLocatorFactory, ClassLoader loader, Field field) {
        return decorate((e) -> (T) e.decorateElement(elementLocatorFactory, loader, field));
    }

    @Override
    @SuppressWarnings("unchecked")
    public <T extends AbstractCollection> T decorateCollection(IElementLocatorFactory elementLocatorFactory, ClassLoader loader, Field field) {
        return decorate((e) -> (T) e.decorateCollection(elementLocatorFactory, loader, field));
    }

    @Override
    @SuppressWarnings("unchecked")
    public <T extends WebElementFacade> List<T> decorateList(IElementLocatorFactory elementLocatorFactory, ClassLoader loader, Field field) {
        return decorate((e) -> (List<T>) e.decorateList(elementLocatorFactory, loader, field));
    }

    @Override
    @SuppressWarnings("unchecked")
    public <T extends IPageObject> T decorateBlock(IElementLocatorFactory elementLocatorFactory, ClassLoader loader, Field field) {
