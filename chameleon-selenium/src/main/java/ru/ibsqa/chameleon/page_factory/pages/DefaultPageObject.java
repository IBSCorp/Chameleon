...
import ru.ibsqa.chameleon.page_factory.IPageObjectLoader;
...
public abstract class DefaultPageObject implements IPageObject {
    ...
    public void switchFrames() {
        ru.ibsqa.chameleon.definitions.annotations.selenium.Page aPage = this.getClass().getAnnotation(ru.ibsqa.chameleon.definitions.annotations.selenium.Page.class);
        if (null != aPage) {
