...
import static ru.ibsqa.chameleon.page_factory.PageFactoryUtils.isCollection;
    ...
    private Iterable<? extends IPageObject> searchField(IPageObject pageObject, String fieldName){
        ...
        for (Field field: pageObject.getClass().getDeclaredFields()) {
            if (isCollection(field)){
                if (field.getAnnotation(ru.ibsqa.chameleon.definitions.annotations.selenium.Field.class).name().equals(fieldName)){
