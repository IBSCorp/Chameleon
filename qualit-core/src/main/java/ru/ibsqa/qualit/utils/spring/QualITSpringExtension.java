...
import static ru.ibsqa.qualit.utils.spring.SpringUtils.getRootException;

public class QualITSpringExtension extends SpringExtension {

    private static final ExtensionContext.Namespace TEST_CONTEXT_MANAGER_NAMESPACE = ExtensionContext.Namespace.create(QualITSpringExtension.class);
    ...
    private static final ExtensionContext.Namespace AUTOWIRED_VALIDATION_NAMESPACE =
            ExtensionContext.Namespace.create(QualITSpringExtension.class.getName() + "#autowired.validation");
    ...
    private static final ReflectionUtils.MethodFilter autowiredTestOrLifecycleMethodFilter =
            ReflectionUtils.USER_DECLARED_METHODS
                    ...
                    .and(QualITSpringExtension::isAutowiredTestOrLifecycleMethod);
